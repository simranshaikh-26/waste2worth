...
<div className="w-10 h-10 bg-primary rounded-x1 flex items-center justify-center">
...
<Card className="border-0 shadow-1g bg-food/10 backdrop-blur-sm">

<CardContent className="p-4 text-center">

<div className="text-2x1 font-bold text-food">{stats.mealsSaved}</div>
...
<div className="text-2x1 font-bold text-primary">{stats.plasticRecycled}kg</div>
...
<div className="text-2x1 font-bold text-success">{stats.compostGenerated}kg</div>
...
<div className="grid gap-6 max-w-2x1 mx-auto">

{/* Donate Food */}

<Link to="/donate-food">

<Card className="border-0 shadow-x1 bg-gradient-to-r from-food to-food/80 hover:shadow-2x1 transition-all duration-300 cursor-pointer group">
...
<h2 className="text-2x1 font-bold text-food-foreground mb-2">Donate Food</h2>

<p className="text-food-foreground/88">Share surplus meals with NGOs and volunteers nearby</p>
...
<Card className="border-0 shadow-x1 bg-gradient-to-r from-success to-success/80 hover:shadow-2x1 transition-all duration-300 cursor-pointer group">

<CardContent className="p-8">

<div className="flex items-center gap-6">

<div className="w-16 h-16 bg-success-foreground/20 rounded-2x1. flex items-center justify-center group-hover:scale-110 transition-transform">
...
<Card className="border-0 shadow-x1 bg-gradient-to-r from-primary to-primary-glow hover:shadow-2x1 transition-all duration-300 cursor-pointer group">

<CardContent className="p-8">

<div className="w-16 h-16 bg-primary-foreground/20 rounded-2x1 flex items-center justify-center group-hover:scale-110 transition-transform">
...
<h2 className="text-2x1 font-bold text-primary-foreground mb-2">Recycle Plastic</h2>

<p className="text-primary-foreground/">Identify plastic types and find recycling centers</p>
